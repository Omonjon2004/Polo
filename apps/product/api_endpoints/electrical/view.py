...
from rest_framework.permissions \
    import IsAuthenticated, AllowAny

from apps.product.api_endpoints.electrical.serializers \
    import ElectricalSerializer
from apps.product.models import Electrical


class ElectricalListCreateAPIView \
...
class ElectricalRetrieveUpdateDestroyAPIView \
...
__all__ = [
    'ElectricalListCreateAPIView',
    'ElectricalRetrieveUpdateDestroyAPIView'
]
