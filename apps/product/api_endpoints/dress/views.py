...
class DressListCreateAPIView(ListCreateAPIView):
...
class DressRetrieveUpdateDestroyAPIView(RetrieveUpdateDestroyAPIView):
    serializer_class = DressSerializer
    queryset = Dress.objects.all()


__all__ = ['DressListCreateAPIView', 'DressRetrieveUpdateDestroyAPIView']
